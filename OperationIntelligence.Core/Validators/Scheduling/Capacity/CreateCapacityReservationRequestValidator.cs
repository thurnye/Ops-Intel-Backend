...
public class CreateCapacityReservationRequestValidator : AbstractValidator<CreateCapacityReservationRequest>
{
    public CreateCapacityReservationRequestValidator()
    {
