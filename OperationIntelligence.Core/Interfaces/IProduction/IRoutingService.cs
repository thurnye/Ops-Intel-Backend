...
public interface IRoutingService
{
    ...
    Task<RoutingMetricsSummaryResponse> GetSummaryAsync(CancellationToken cancellationToken = default);
    ...
    Task<BulkCreateResponse<RoutingResponse>> CreateBulkAsync(BulkCreateRequest<CreateRoutingRequest> request, string? createdBy = null, CancellationToken cancellationToken = default);
