...
public interface IWarehouseService
{
    ...
    Task<BulkCreateResponse<WarehouseResponse>> CreateBulkAsync(BulkCreateRequest<CreateWarehouseRequest> request, CancellationToken cancellationToken = default);
