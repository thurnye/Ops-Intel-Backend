...
public class WarehousesController : BaseApiController
{
    ...
    [HttpPost("bulk")]
    public async Task<IActionResult> CreateBulk([FromBody] BulkCreateRequest<CreateWarehouseRequest> request, CancellationToken cancellationToken)
    {
        var result = await _warehouseService.CreateBulkAsync(request, cancellationToken);
